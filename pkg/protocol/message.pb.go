...
type Message struct {
	...
	From          string                 `protobuf:"bytes,3,opt,name=from,proto3" json:"from,omitempty"`                 // 发送消息用户 uuid
	To            string                 `protobuf:"bytes,4,opt,name=to,proto3" json:"to,omitempty"`                     // 发送给对端用户的 uuid
	...
	Type          string                 `protobuf:"bytes,7,opt,name=type,proto3" json:"type,omitempty"`                 // 消息传输类型：如果是心跳消息，该内容为heatbeat, 在线视频或者音频为 webrtc
...
const file_message_proto_rawDesc = "" +
	...
	" \x01(\tR\n" +
	"fileSuffix\x12\x12\n" +
	"\x04file\x18\v \x01(\fR\x04fileB\x03Z\x01.b\x06proto3"
